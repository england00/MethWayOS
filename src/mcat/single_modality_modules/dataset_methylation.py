...
class MethylationDataset(Dataset):
    ...
    def split(self, training_size):
        ...
        patient_survival_class = self.methylation.groupby('case_id')['survival_class'].first().loc[unique_patients]
    ...
    def k_fold_split(self, training_dataset, k):
        ...
        patient_survival_class = meth_dataframe.groupby('case_id')['survival_class'].first().loc[unique_patients]
