...
from src.mcat.gene_expression_and_methylation_modules.testing import testing
from src.mcat.original_modules.loss import CrossEntropySurvivalLoss, SurvivalClassificationTobitLoss
from src.mcat.original_modules.utils import l2_reg
...
def wandb_init(config):
    ...
    wandb.init(
        ...
        config={
            ...
            'gene_expression_correlation_threshold': config['dataset']['gene_expression_correlation_threshold'],
            'methylation': config['dataset']['methylation'],
            'methylation_signatures': config['dataset']['methylation_signatures'],
            'methylation_islands_correlation_threshold': config['dataset']['methylation_islands_correlation_threshold'],
            'methylation_island_number_per_column': config['dataset']['methylation_island_number_per_column'],
