...
''' Output Dataset '''
GENE_EXPRESSION_MCAT_WSI = 'gene_expression_MCAT_wsi'
GENE_EXPRESSION_KEYS_WSI = 'gene_expression_keys_wsi'
...
if __name__ == "__main__":
    ...
    csv_storer(table_paths[GENE_EXPRESSION_KEYS_WSI], gene_expression_keys, ["gene"], keys_mode=True)
    ...
    dataframe.to_csv(dataset_paths[GENE_EXPRESSION_MCAT_WSI], index=True)
    print(f"Data has been correctly saved inside {dataset_paths[GENE_EXPRESSION_MCAT_WSI]} file")
