...
def dataset_acquisition(path):
    # Loading COLUMNS
    dataframe, dataframe_columns = csv_loader(path, JSON_PATHS_YAML, METHYLATION_NAMES)
...
if __name__ == "__main__":
    ...
    dataset, dataset_columns = dataset_acquisition(path=dataset_paths[METHYLATION])
