...
def create_ensemble(models):
    """
    Creates an ensemble from the list of models.

    :param models: List of trained models.
    :return: Function that averages predictions from the models.
    """
    ...
    def ensemble_predict(x):
        ...
        return torch.mean(torch.stack(predictions), dim=0)  # Averaging the predictions
