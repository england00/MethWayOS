...
def grid_search(device, x, y, shuffle, rand_state, hyperparameters, k_folds, x_test=None, y_test=None):
    """
                ...
                for alpha in hyperparameters["alpha"]:
                    for dropout in hyperparameters["dropout"]:
                        for weight_decay in hyperparameters["weight_decay"]:
                            ...
                            if (mean_accuracy > best_mean_accuracy) or mean_validation_loss < (best_mean_validation_loss + 0.1):
                                best_parameters = {
