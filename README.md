...
- [AIforBioinformatics](.)
    ...
    - [Source Files](./src)
        - [Data Extractors](./src/data_extractors)
            ...
            - [0.2.3 - METHYLATION VECTORS for each GENE Extractor ---> 'selected_methylation_islands_data.json'](./src/data_extractors/0.2.3_methylation_vectors_for_each_gene.py)
            - [0.2.4 - GENE ASSOCIATED METHYLATION Extractor ---> 'gene_associated_methylation_data.json'](./src/data_extractors/0.2.4_gene_associated_methylation_extractor.py)
        ...
        - [Dataset Creators](./src/dataset_creators)
            ...
            - [1.3 - GENE EXPRESSION & METHYLATION & OS - Dataset ---> 'gene_expression_and_methylation_and_overall_survival_dataset.csv'](./src/dataset_creators/1.3_gene_expression_&_methylation_&_overall_survival.py)
